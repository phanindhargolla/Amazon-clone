      ...
      <div className="flex items-center bg-amazon_blue p-1 flex-grow py-2">
        ...
        <div className="text-white flex items-center text-xs space-x-6 mx-6 whitespace-nowrap">
          ...
          <div onClick={() => router.push('/checkout')} className="link flex items-center relative">
            <span className="absolute top-0 right-0 md:top-0 md:right-10 bg-yellow-400 text-center h-4 w-4 rounded-full text-black font-bold">{items.length}</span>
          ...
          {/*Bottom Nav*/}
          <div className="flex items-center bg-amazon_blue-light space-x-3 p-2 pl-6 text-md text-white">
